 ...
 */
public class page4_4 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page4_4);

        //เล่านิทาน
        mediaPlayer = MediaPlayer.create(this, R.raw.pg4_4);
        mediaPlayer.start();

        soundBG = new soundBG(page4_4.this);
        ...
        btnPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogsetting.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DialogSetting setDialog = new DialogSetting(page4_4.this);
                        setDialog.show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_back:
                ...
                break;
            case R.id.btn_next:
                i = new Intent(getApplicationContext(), scene4_4.class);
                startActivity(i);
                break;
        }
