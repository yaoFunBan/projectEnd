...
public class database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String[] word = {"พระชนนี ", "รองพระบาท ", "สังวาล ", "ชฏา", "พระสนับเพลา", "พระกระยาเสวย", "รัดพระองค์", "ฉลองพระองค์", "พระทวาร", "พระสุธารส", "พระเกศา"
                , "พระอุทร", "พระโมฬี", "พระนาสิก", "พระกรรณ", "พระฉวี", "ข้อพระบาท", "พระโอษฐ์", "พระมังสา", "น้ำพระเนตร", "พระพักตร์"
                , "พระราศี ", "พระชนก", "พระเชษฐา", "พระสัสสุระ", "พระสวามี", "พระชนนี", "พระสุณิสา", "พระเทวัน", "พระชามาดา"};
