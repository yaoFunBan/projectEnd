 ...
 */
public class page2_4 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page2_4);

        mediaPlayer = MediaPlayer.create(this, R.raw.ss2_4);
        mediaPlayer.start();

        soundBG = new soundBG(page2_4.this);
        ...
        btn_pause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogset.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DialogSetting setDialog = new DialogSetting(page2_4.this);
                        setDialog.show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_back:
                ...
                break;
            case R.id.btn_next:
                i = new Intent(getApplicationContext(), scene2_4.class);
                startActivity(i);
                break;
        }
